...
function task_parent_draw_object() {
    var _object_x = lerp(object_begin_x, object_target_x, state_tick_alpha);
    var _object_y = lerp(object_begin_y, object_target_y, state_tick_alpha);
    show_debug_message("Drawing object at: " + string(_object_x) + ", " + string(_object_y));
...
function task_parent_draw_title() {
    ...
    draw_set_alpha(state_tick_alpha);
    draw_set_colour(c_black);
